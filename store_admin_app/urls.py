...
urlpatterns = [
	...
	url(r'^coupons/$',CuponsListView ,name='coupon-view'),
	...
	url(r'^coupon/create/$',CuponsCreatelView ,name='coupon-create-view'),
	...
	url(r'^coupon/crud/(?P<id>[0-9]+)/$',CuponCRUDView ,name='coupon-crud-view'),
